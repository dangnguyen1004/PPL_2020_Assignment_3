...
Symbol("printStrLn",MType([StringType()],VoidType()))]                           
    ...
    def visitProgram(self,ast, c):
        ...
        # Add list function with Unknown type parameters to environment for the purpose call function before decl
        listDeclName = [] + [decl.name for decl in c] # For check redeclared
        for decl in ast.decl:
            ...
            else: # type(decl) is VarDecl
                listDeclName += [decl.variable.name]
        # Visit FuncDecl
    ...
    def visitFuncDecl(self,ast, c):
        ...
        # Assign param type from the environment 
        ...
        # Assign type back to environment
    ...
    def visitCallExpr(self,ast, c):
        ...
        # Find the called function in the environment
        functionCall = None
        ...
        for index in range(0, len(listTypeOfParam)):
            ...
            if type(typeOfArg) is Unknown and type(typeOfParam) is Unknown:
                ...
                assignTypeTo(ast.param[index], typeOfArg, c)
    ...
    def visitIf(self,ast, c):
        ...
        for ifThenStmt in ast.ifthenStmt:
            ...
            if type(conditionExp) is Unknown:
                assignTypeTo(ifThenStmt[0], BoolType(), c)
    ...
    def visitDowhile(self,ast, c):
        ...
        if type(exp) is Unknown:
            assignTypeTo(ast.exp, BoolType(), c)
    ...
    def visitBinaryOp(self,ast, c):
        ...
        if operator in ['+','-','*','\\','%']:
            if type(typeOfLeft) is IntType and type(typeOfRight) is IntType:
                ...
                assignTypeTo(ast.left, IntType(), c)
                return IntType()
            elif type(typeOfLeft) is IntType and type(typeOfRight) is Unknown:
                assignTypeTo(ast.right, IntType(), c)
                return IntType()
            ...
            if type(typeOfLeft) is FloatType and type(typeOfRight) is FloatType:
                ...
                assignTypeTo(ast.left, FloatType(), c)
                return FloatType()
            elif type(typeOfLeft) is FloatType and type(typeOfRight) is Unknown:
                assignTypeTo(ast.right, FloatType(), c)
                return FloatType()
            elif type(typeOfLeft) is Unknown and type(typeOfRight) is Unknown:
                assignTypeTo(ast.left, FloatType(), c)
                assignTypeTo(ast.right, FloatType(), c)
            ...
            if type(typeOfLeft) is BoolType and type(typeOfRight) is BoolType:
                ...
                assignTypeTo(ast.left, BoolType(), c)
                return BoolType()
            elif type(typeOfLeft) is BoolType and type(typeOfRight) is Unknown:
                assignTypeTo(ast.right, BoolType(), c)
                return BoolType()
            elif type(typeOfLeft) is Unknown and type(typeOfRight) is Unknown:
                assignTypeTo(ast.left, BoolType(), c)
                assignTypeTo(ast.right, BoolType(), c)
    ...
    def visitUnaryOp(self,ast, c):
        ...
        if operator == '!':
            if type(typeOfExp) is BoolType:
                ...
                assignTypeTo(typeOfExp, BoolType(), c)
                return BoolType(0)
            ...
            if type(typeOfExp) is IntType:
                ...
                assignTypeTo(typeOfExp, IntType(), c)
                return IntType()
            elif type(typeOfExp) is Un:
                 return Un()
            else:
            ...
            if type(typeOfExp) is FloatType:
                ...
                assignTypeTo(typeOfExp, FloatType(), c)
                return FloatType()
            elif type(typeOfExp) is Un:
                 return Un()
            else:
